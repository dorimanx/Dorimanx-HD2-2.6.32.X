...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 245000, CCTL(CLK_MODEM_PLL, 1),	SRC_RAW, 0, 0, 1000, 29000 },
        ...
        { 1420800, CCTL(CLK_TCXO, 1),           SRC_SCPLL, 0x1E, 0, 1325, 128000 },
        { 1459200, CCTL(CLK_TCXO, 1),           SRC_SCPLL, 0x1E, 0, 1325, 128000 },
        { 1497600, CCTL(CLK_TCXO, 1),           SRC_SCPLL, 0x1E, 0, 1325, 128000 },
        { 1536000, CCTL(CLK_TCXO, 1),           SRC_SCPLL, 0x1E, 0, 1325, 128000 },
	{ 1574400, CCTL(CLK_TCXO, 1),           SRC_SCPLL, 0x1E, 0, 1325, 128000 },
