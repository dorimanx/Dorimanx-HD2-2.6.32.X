...
make ARCH=arm CROSS_COMPILE=/root/CodeSourcery/Sourcery_G++_Lite/bin/arm-none-linux-gnueabi- zImage -j6
...
rm -rf /home/root/kernel/dorimanx-tytyng/output_gb/system/lib/modules/*
make ARCH=arm CROSS_COMPILE=/root/CodeSourcery/Sourcery_G++_Lite/bin/arm-none-linux-gnueabi- modules -j8
make ARCH=arm CROSS_COMPILE=/root/CodeSourcery/Sourcery_G++_Lite/bin/arm-none-linux-gnueabi- INSTALL_MOD_PATH=/home/root/kernel/dorimanx-tytyng/output_gb/system/lib/modules modules_install -j8
...
mv /home/root/kernel/dorimanx-tytyng/output_gb/Kernel_Dorimanx-V1.*-2way-rec.zip /home/root/kernel/dorimanx-tytyng/
zip -r Kernel_Dorimanx-V1.`date +"%H-%M-%d%m%y"`-2way-rec-OFF.zip .
mv /home/root/kernel/dorimanx-tytyng/Kernel_Dorimanx-V1.*-2way-rec.zip /home/root/kernel/dorimanx-tytyng/output_gb/
else
